	...
	*/
	...
	protected function register_controls() {
	    ...
	    $this->start_controls_section(
	       'wbea_section_subheading_contents',
		    [
		...
		$this->add_control(
			'wbea_section_subheading_show_btn',
			[
		...
		$this->add_control(
			...
			[
				...
				'separator' => 'before',
				'condition' => [
					'wbea_section_subheading_show_btn' => 'yes'
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => 'before',
				'condition' => [
					'wbea_section_desc_show_btn' => 'yes'
				],
			]
		);
		...
		$this->add_control(
		    'wbea_section_heading_btn_title',
			[
				...
				'separator' => 'before',
				'condition' => [
					'wbea_section_heading_show_btn' => 'yes'
				],
			]
		);
		...
		$this->start_controls_section(
			'wbea_section_heading_pro_message',
			[
		...
		// Section Pro Message
		$this->add_control( 
			'wbea_section_heading_pro_message_notice', 
			[
		...
		$this->add_responsive_control(
			'wbea_section_heading_alignment',
			[
				...
				'default' => 'center',
				'selectors' => [
					'{{WRAPPER}} .wbea-section-title' => 'text-align: {{VALUE}}',
				],
				'separator' => 'before'
			],
		);
		...
		// Heading Control
		$this->add_control(
			'wbea_section_subheading_bullet_style',
			[
		...
		$this->add_control(
			'wbea_section_heading_separator_round',
			[
				'label' => esc_html__( 'Border Radius', 'webbricks-addons' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%'],
				'selectors' => [
					'{{WRAPPER}} .wbea-section-title span.wbea-section-subheading:before' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
		...
		$this->add_control(
			'wbea_section_heading_separator_color',
			[
				'label' => esc_html__( 'Color', 'webbricks-addons' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wbea-section-title span.wbea-section-subheading:before' => 'background-color: {{VALUE}}',
				],
				'global' => [
					'default' => Global_Colors::COLOR_ACCENT,
				],
				'condition' => [
					'wbea_section_heading_separator_variation!' => 'none',
				],
			]
		);
		...
		// Heading Control
		$this->add_control(
			'wbea_section_subheading_heading_style',
			[
		...
		$this->add_control(
			'wbea_section_subheading_color',
			[
				'label' => esc_html__( 'Text Color', 'webbricks-addons' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .wbea-section-title span.wbea-section-subheading' => 'color: {{VALUE}}',
				],
				'global' => [
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'wbea_section_heading_typography',
		...
		$this->start_controls_section(
			'wbea_section_heading_button_style',
			[
				'label' => esc_html__( 'Button', 'webbricks-addons' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
		...
		$this->start_controls_tabs(
			'wbea_section_heading_btn_style_tabs'
		);

		// Section Heading Button Normal Tab
		$this->start_controls_tab(
			'wbea_section_heading_button_normal_tab',
			[
		...
		$this->add_control(
			'wbea_section_heading_btn_color',
			[
				'label' => esc_html__( 'Text Color', 'webbricks-addons' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'wbea_section_heading_btn_typography',
		...
		$this->add_control(
			'wbea_section_heading_btn_border_color',
			[
		...
		$this->add_control(
			'wbea_section_heading_btn_border_radius',
			[
				'label' => esc_html__( 'Border Radius', 'webbricks-addons' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%'],
		...
		$this->add_control(
			'wbea_section_heading_btn_padding',
			[
		...
		$this->start_controls_tab(
			'wbea_section_heading_button_hover_tab',
			[
		...
		$this->add_control(
			'wbea_section_heading_btn_hover_color',
			[
				'label' => esc_html__( 'Text Color', 'webbricks-addons' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'wbea_section_heading_btn_hover_bg',
			[
		...
		$this->add_control(
			'wbea_section_heading_btn_hover_border',
			[
				'label' => esc_html__( 'Border Color', 'webbricks-addons' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function render() {
		...
		$wbea_section_heading_tag = in_array($wbea_section_heading_tag, $allowed_heading_tags, true) ? $wbea_section_heading_tag : 'h2';
		...
		<div class="wbea-section-title">
			<?php if ($wbea_section_subheading_show_btn === 'yes') : 
				...
				<span class="<?php echo esc_attr($wbea_section_heading_separator_variation); ?> wbea-section-subheading">
					<?php echo esc_html($wbea_section_subheading); ?>
				</span>
			<?php endif; ?>
	
			<<?php echo esc_attr($wbea_section_heading_tag); ?> class="wbea-section-heading">
				<?php echo esc_html($wbea_section_heading); ?>
			</<?php echo esc_attr($wbea_section_heading_tag); ?>>
	
			<?php if ($wbea_section_desc_show_btn === 'yes') : 
				$wbea_section_desc = $settings['wbea_section_desc'] ?? '';
				?>
				<p><?php echo wp_kses_post($wbea_section_desc); ?></p>
			<?php endif; ?>
	
			<?php if ($wbea_section_heading_show_btn === 'yes') : 
				$wbea_section_heading_btn_title = $settings['wbea_section_heading_btn_title'] ?? '';
				$wbea_section_heading_btn_link = $settings['wbea_section_heading_btn_link']['url'] ?? '';
